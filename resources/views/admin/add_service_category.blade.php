                ...
                <div class="row portfolioContainer">
                    <div class="col-md-8 col-md-offseet-2 profile1">
                        <div class="panel panel-default">
                            <div class="panel heading">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="{{route('admin.ServiceCategories')}}" method="POST" class="btn btn-info pull-right">All Categories</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            @endif
                            <form action="{{route('admin.store_Service_Categories')}}" method="POST" class="form-horizontal" enctype="multipart/form-data" >
                                @csrf
