...
<header id="header" class="header-v3">
    <nav class="flat-mega-menu">
        ...
        <ul class="collapse">
            ...
            <li> <a href="{{route('Home.ServiceCategories')}}">ServicesCategories</a>
            ...
            <li> <a href="#">Control</a>
                <ul class="drop-down one-column hover-fade">
                    <li><a href="{{route('admin.add_Service_Categories')}}">Add Categories</a></li>
                    <li><a href="{{route('admin.ServiceCategories')}}">All Categories</a></li>
                    <li><a href="{{route('admin.add_Service')}}">Add Service</a></li>
                    <li><a href="{{route('admin.all_Service_Categories')}}">All Services</a></li>
                    <li><a href="{{route('admin.contacts')}}">All Contact Message</a></li>
