...
<section class="content-central">
    <div class="semiboxshadow text-center">
        الصورة
        {{-- <img src="{{asset('')}}{{$service->image}}" class="img-responsive" alt="{{$service->name}}"> --}}
    </div>
                                    ...
                                    <div class="post-header">
                                        ...
                                        <div class="post-info-wrap">
                                            <h2 class="post-title"><a href="#" title="Post Format: Standard"
                                                    rel="bookmark">Ac Servicing:Ac </a></h2>
                                                    {{-- rel="bookmark">{{$service->name}} Servicing: {{$service->name}}</a></h2> --}}
