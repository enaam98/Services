        ...
        <header id="header" class="header-v3">
            <nav class="flat-mega-menu">
                ...
                <ul class="collapse">
                    ...
                    <li> <a href="{{route('Home.ServiceCategories')}}"> Service Categories</a> </li>
                    ...
                    <li class="login-form"> <a href="#" title="Register">My Account (Admin)</a>
                        <ul class="drop-down one-column hover-fade">
                            ...
                            <li><a href="{{route('logout')}}" onclick="event.preventDefault(); document.getElementById('logoutid').submit();">Logout</a></li>
                        </ul>
                    </li>
                    ...
                    @endif
                 <form id="logoutid" method="POST" action="{{route('logout')}}" >
                @csrf
                 </form>
                    @else
